...
<div class="text-center">
                    <h2 class="page-section-heading text-secondary mb-0 d-inline-block">VIEW VEHICLE FLAGGING STATUS</h2>
                </div>
...
<strong><ul><li>Enter the ID number of a registerd owner.</li>
            <li> For Vehcicles owned by Companies, Check the ID assigned to the Company on the Registration Book. </li>
            <li> Vehicle flagging charges can be paid at the nearest Police Station.</li>
          </ul></strong>
<div align='center'>
