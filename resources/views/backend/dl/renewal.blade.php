...
<div class="text-center">
                    <h2 class="page-section-heading text-secondary mb-0 d-inline-block">DRIVERS' LICENCE RENEWAL</h2>
                </div>

                <!-- Icon Divider-->
                <div class="divider-custom">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><p>ENTER CUSTOMER IDENTIFICATION NUMBER</p></div>
                    <div class="divider-custom-line"></div>
                </div>
        ...
        <div class="control-group">
            <div class="controls">
                <div class="main_input_box">
                    <span class="page-section-heading text-secondary mb-0 d-inline-block"><h3>SURNAME</h3></span><br/>
                    <input type="text" name="surname" size="80px" placeholder="Enter customer Surname............"/>
                </div>
                <span class="error">
